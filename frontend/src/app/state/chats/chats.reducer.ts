...
import {addChatSuccess, loadChats, loadChatsFailure, loadChatsSuccess, setChatsSearch} from './chats.actions';
...
export const chatsReducer = createReducer(
  ...
  on(setChatsSearch, (state, {search}) => ({ ...state, searchName: search })),
